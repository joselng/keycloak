...
public final class OIDCConfigAttributes {
    ...
    public static final String USE_LOWER_CASE_IN_TOKEN_RESPONSE = "use.lower.case.in.token.response";


    public static final String FRONT_CHANNEL_LOGOUT_URI = "front.channel.logout.uri";
    public static final String FRONT_CHANNEL_LOGOUT_SESSION_REQUIRED = "front.channel.logout.session.required";
